...
class Node():
    #The parent edge is the action that led to this state. 
    #If the parent edge is null, this node is the root of the tree.
    parent_edge = None
...
#----MCTS
    ...
    def choose(self):
        ...
        for stat in sorted(self.root.values(),
            ...
            print("value: ", stat.get(self.match.our_role_index))
            if s > best_score:
                best_score = s
                best_selection = stat
